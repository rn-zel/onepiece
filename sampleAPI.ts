...
export function setAuthToken(token: string | null) {
  ...
  // New token implies new session context
...
/** POST /play – main game spin (Laravel contract: bets.bet_size / bets.bet_level). */
...
/** POST /buy-free-game – buy free spins (Laravel contract: bets.bet_size / bets.bet_level). */
