...
import titleSheetPath from "../assets/titlevid.png";
...
export class TitleUI {
    ...
    constructor() {
        ...
        this.staticSprite = new Sprite(Assets.get("title.png"));
    ...
    private async initSpritesheet() {
        ...
        this.animSprite.x = CONFIG.TITLE_X - 45;
        this.animSprite.y = CONFIG.TITLE_Y + 15;
        ...
        this.animSprite.scale.set(fitScale - .05);
