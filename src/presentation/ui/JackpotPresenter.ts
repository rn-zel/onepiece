...
export class JackpotPresenter {
    ...
    public async show(type: "mini" | "major" | "grand", amount: number): Promise<void> {
        ...
        tl.to(this.titleText.scale, { x: 1.2, y: 1.2, duration: 0.6, ease: "back.out(2)" }, "-=0.2");
        tl.to(this.amountText.scale, { x: 1, y: 1, duration: 0.6, ease: "back.out(2)" }, "-=0.4");
