...
const SHARED = {
  ...
  UI_HUD_RESOLUTION: 10,
  UI_HUD_TITLE_SIZE: 40,
  UI_HUD_CREDIT_SIZE: 46,
  UI_HUD_BET_SIZE: 46,
  UI_HUD_TOTAL_WIN_SIZE: 46,
  UI_WIN_RESOLUTION: 10,
  UI_JACKPOT_RESOLUTION: 10,
  UI_WIN_SIZE: 100,
  UI_BONUS_SIZE: 40,
  ...
  HUD_VALUE_GLOW_BLUR: 6,
  JACKPOT_VALUE_FILL: 0x9c7740,
  JACKPOT_VALUE_STROKE_COLOR: 0x000000,
  JACKPOT_VALUE_STROKE_WIDTH: 4,
  UI_COLORS: {
  ...
  NORMAL_WIN_DELAY: 3,
  TOTAL_WIN_PANEL_DELAY: 3.0,
  WIN_TEXT_POPUP_SPEED: 0.6,
  PANEL_POPUP_SPEED: 0.5,
  SYMBOL_ANIM_SPEED: 0.1,
  ...
  MACHINE_SCALE_MOBILE_LANDSCAPE: 0.8,
  MACHINE_SCALE_MOBILE_PORTRAIT: 0.66, 
