...
export class GameState {
    ...
    set currentBet(value: number) { this._currentBet = value; }

    get totalWin(): number { return this._totalWin; }
    set totalWin(value: number) { this._totalWin = value; }

    get freeSpinsCount(): number { return this._freeSpinsCount; }
    set freeSpinsCount(value: number) { this._freeSpinsCount = value; }

    get currentGrid(): number[][] | null { return this._currentGrid; }
    set currentGrid(value: number[][] | null) { this._currentGrid = value; }
     ...
     */
    public updateFromPlayData(data: { balance: number; total_win: number; free_spin?: { count: number } | null }) {
